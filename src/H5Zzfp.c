...
#define H5Z_ZFP_H5E_ARGS_MSG       "Invalid arguments to routine"
#define H5Z_ZFP_H5E_PLINE_MSG      "Data filters"
#define H5Z_ZFP_H5E_RESOURCE_MSG   "Resource unavailable"
#define H5Z_ZFP_H5E_BADTYPE_MSG    "Inappropriate type"
#define H5Z_ZFP_H5E_BADVALUE_MSG   "Bad value"
#define H5Z_ZFP_H5E_CANTFILTER_MSG "Filter operation failed"
#define H5Z_ZFP_H5E_CANTGET_MSG    "Can't get value"
#define H5Z_ZFP_H5E_CANTINIT_MSG   "Unable to initialize object"
#define H5Z_ZFP_H5E_NOSPACE_MSG    "No space available for allocation"
#define H5Z_ZFP_H5E_OVERFLOW_MSG   "Address overflowed"
...
static hid_t H5Z_ZFP_H5E_ARGS = -1;
static hid_t H5Z_ZFP_H5E_PLINE = -1;
static hid_t H5Z_ZFP_H5E_RESOURCE = -1;
static hid_t H5Z_ZFP_H5E_BADTYPE = -1;
static hid_t H5Z_ZFP_H5E_BADVALUE = -1;
static hid_t H5Z_ZFP_H5E_CANTFILTER = -1;
static hid_t H5Z_ZFP_H5E_CANTGET = -1;
static hid_t H5Z_ZFP_H5E_CANTINIT = -1;
static hid_t H5Z_ZFP_H5E_NOSPACE = -1;
static hid_t H5Z_ZFP_H5E_OVERFLOW = -1;
...
static void H5Z_zfp_init(void)
{
    ...
    H5Z_ZFP_ERRCLASS =       H5Eregister_class("H5Z-ZFP", "ZFP-" ZFP_VERSION_STR, "H5Z-ZFP-" H5Z_FILTER_ZFP_VERSION_STR);
    H5Z_ZFP_H5E_ARGS =       H5Ecreate_msg(H5Z_ZFP_ERRCLASS, H5E_MAJOR, H5Z_ZFP_H5E_ARGS_MSG);
    H5Z_ZFP_H5E_PLINE =      H5Ecreate_msg(H5Z_ZFP_ERRCLASS, H5E_MAJOR, H5Z_ZFP_H5E_PLINE_MSG);
    H5Z_ZFP_H5E_RESOURCE =   H5Ecreate_msg(H5Z_ZFP_ERRCLASS, H5E_MAJOR, H5Z_ZFP_H5E_RESOURCE_MSG);
    H5Z_ZFP_H5E_BADTYPE =    H5Ecreate_msg(H5Z_ZFP_ERRCLASS, H5E_MINOR, H5Z_ZFP_H5E_BADTYPE_MSG);
    H5Z_ZFP_H5E_BADVALUE =   H5Ecreate_msg(H5Z_ZFP_ERRCLASS, H5E_MINOR, H5Z_ZFP_H5E_BADVALUE_MSG);
    H5Z_ZFP_H5E_CANTFILTER = H5Ecreate_msg(H5Z_ZFP_ERRCLASS, H5E_MINOR, H5Z_ZFP_H5E_CANTFILTER_MSG);
    H5Z_ZFP_H5E_CANTGET =    H5Ecreate_msg(H5Z_ZFP_ERRCLASS, H5E_MINOR, H5Z_ZFP_H5E_CANTGET_MSG);
    H5Z_ZFP_H5E_CANTINIT =   H5Ecreate_msg(H5Z_ZFP_ERRCLASS, H5E_MINOR, H5Z_ZFP_H5E_CANTINIT_MSG);
    H5Z_ZFP_H5E_NOSPACE =    H5Ecreate_msg(H5Z_ZFP_ERRCLASS, H5E_MINOR, H5Z_ZFP_H5E_NOSPACE_MSG);
    H5Z_ZFP_H5E_OVERFLOW =   H5Ecreate_msg(H5Z_ZFP_ERRCLASS, H5E_MINOR, H5Z_ZFP_H5E_OVERFLOW_MSG);
}
...
{   
    ...
    if (B (int) stream_word_bits != 8)
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_CANTINIT, -1,
    ...
    if (H5T_NO_CLASS == (dclass = H5Tget_class(type_id)))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_BADTYPE, -1, "bad datatype class");

    if (0 == (dsize = H5Tget_size(type_id)))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_BADTYPE, -1, "bad datatype size");

    if (0 > (ndims = H5Sget_simple_extent_dims(chunk_space_id, dims, 0)))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_BADTYPE, -1, "bad chunk data space");

    /* confirm ZFP library can handle this data */
#if ZFP_VERSION_NO < 0x0051
    if (!(dclass == H5T_FLOAT))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_BADTYPE, 0,
    ...
    if (ndims_used == 0 || ndims_used > max_ndims)
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_BADVALUE, 0,
...
{   
    ...
    if (0 > (dclass = H5Tget_class(type_id)))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_ARGS, H5Z_ZFP_H5E_BADTYPE, -1, "not a datatype");

    if (0 == (dsize = H5Tget_size(type_id)))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_ARGS, H5Z_ZFP_H5E_BADTYPE, -1, "not a datatype");

    if (0 > (ndims = H5Sget_simple_extent_dims(chunk_space_id, dims, 0)))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_ARGS, H5Z_ZFP_H5E_BADTYPE, -1, "not a data space");
...
#endif
        default: H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_BADVALUE, 0,
                     "chunks may have only 1-3 (or 4) non-unity dims");
    }
    if (!dummy_field)
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_RESOURCE, H5Z_ZFP_H5E_NOSPACE, 0, "zfp_field_Xd() failed");
    ...
    if (0 > H5Pget_filter_by_id(dcpl_id, H5Z_FILTER_ZFP, &flags, &mem_cd_nelmts, mem_cd_values, 0, NULL, NULL))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_CANTGET, 0, "unable to get current ZFP cd_values");
    ...
    if (mem_cd_nelmts == 0)
    {
        ...
        if (0 < H5Pexist(dcpl_id, "zfp_controls"))
        {
            if (0 > H5Pget(dcpl_id, "zfp_controls", &ctrls))
                H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_CANTGET, 0, "unable to get ZFP controls");
            have_zfp_controls = 1;
        }
    ...
    if (0 == (dummy_bstr = B stream_open(&hdr_cd_values[1], sizeof(hdr_cd_values))))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_RESOURCE, H5Z_ZFP_H5E_NOSPACE, 0, "stream_open() failed");

    if (0 == (dummy_zstr = Z zfp_stream_open(dummy_bstr)))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_RESOURCE, H5Z_ZFP_H5E_NOSPACE, 0, "zfp_stream_open() failed");
...
#endif
            default:
                H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_BADVALUE, 0, "invalid ZFP mode");
        }
    }
    else
    {
    ...
    if (0 == (hdr_bits = Z zfp_write_header(dummy_zstr, dummy_field, ZFP_HEADER_FULL)))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_CANTINIT, 0, "unable to write header");
    ...
    if (hdr_cd_nelmts > H5Z_ZFP_CD_NELMTS_MAX)
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_BADVALUE, -1, "buffer overrun in hdr_cd_values");
    ...
    uint64 *zfp_mode, uint64 *zfp_meta, H5T_order_t *swap)
{
    ...
    if (cd_nelmts > H5Z_ZFP_CD_NELMTS_MAX)
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_OVERFLOW, 0, "cd_nelmts exceeds max");
    ...
    if (0 == (bstr = B stream_open(&cd_values_copy[0], sizeof(cd_values_copy[0]) * cd_nelmts)))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_RESOURCE, H5Z_ZFP_H5E_NOSPACE, 0, "opening header bitstream failed");

    if (0 == (zstr = Z zfp_stream_open(bstr)))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_RESOURCE, H5Z_ZFP_H5E_NOSPACE, 0, "opening header zfp stream failed");

    /* Allocate the field object */
    if (0 == (zfld = Z zfp_field_alloc()))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_RESOURCE, H5Z_ZFP_H5E_NOSPACE, 0, "allocating field failed");

    /* Do a read of *just* magic to detect possible codec version mismatch */
    if (0 == (Z zfp_read_header(zstr, zfld, ZFP_HEADER_MAGIC)))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_BADVALUE, 0, "ZFP codec version mismatch");
    ...
    if (0 == (Z zfp_read_header(zstr, zfld, ZFP_HEADER_FULL)))
    {
        ...
        if (conv < 0)
            H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_BADVALUE, 0, "header endian-swap failed");

        Z zfp_stream_rewind(zstr);
        if (0 == (Z zfp_read_header(zstr, zfld, ZFP_HEADER_FULL)))
            H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_CANTGET, 0, "reading header failed");
    }
    ...
    size_t *buf_size, void **buf)
{
    ...
    if (0 == get_zfp_info_from_cd_values(cd_nelmts-1, &cd_values[1], &zfp_mode, &zfp_meta, &swap))
        H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_CANTGET, 0, "can't get ZFP mode/meta");
    ...
    if (flags & H5Z_FLAG_REVERSE) /* decompression */
    {
        ...
        if (cd_vals_zfpver > ZFP_VERSION)
            H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_NOSPACE, 0, "ZFP lib version, "
                ZFP_VERSION_STR ", too old to decompress this data");

        /* Set up the ZFP field object */
        if (0 == (zfld = Z zfp_field_alloc()))
            H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_RESOURCE, H5Z_ZFP_H5E_NOSPACE, 0, "field alloc failed");
        ...
        switch (Z zfp_field_type(zfld))
        {
            ...
            default: H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_BADTYPE, 0, "invalid datatype");
        }
        bsize *= dsize;

        if (NULL == (newbuf = malloc(bsize)))
            H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_RESOURCE, H5Z_ZFP_H5E_NOSPACE, 0,
        ...
        if (0 == (bstr = B stream_open(*buf, *buf_size)))
            H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_RESOURCE, H5Z_ZFP_H5E_NOSPACE, 0, "bitstream open failed");

        if (0 == (zstr = Z zfp_stream_open(bstr)))
            H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_RESOURCE, H5Z_ZFP_H5E_NOSPACE, 0, "zfp stream open failed");
        ...
        if (!status)
            H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_CANTFILTER, 0, "decompression failed");
	...
	/* ZFP is an endian-independent format. It will produce correct endian-ness
        ...
        if (swap != H5T_ORDER_NONE)
        {
            ...
            if (H5Tconvert(src, dst, bsize/dsize, newbuf, 0, H5P_DEFAULT) < 0)
                H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_BADVALUE, 0, "endian-UN-swap failed");
        }
    ...
    else /* compression */
    {
        ...
        if (zsize == 0)
            H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_PLINE, H5Z_ZFP_H5E_CANTFILTER, 0, "compression failed");

        if (zsize > msize)
            H5Z_ZFP_PUSH_AND_GOTO(H5Z_ZFP_H5E_RESOURCE, H5Z_ZFP_H5E_OVERFLOW, 0, "uncompressed buffer overrun");
