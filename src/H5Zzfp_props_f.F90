...
#include "H5Zzfp_plugin.h"
  ...
  INTEGER(C_SIZE_T), PARAMETER :: H5Z_ZFP_CD_NELMTS_MEM_F=H5Z_ZFP_CD_NELMTS_MEM  ! used in public API to filter
  INTEGER(C_SIZE_T), PARAMETER :: H5Z_ZFP_CD_NELMTS_MAX_F=H5Z_ZFP_CD_NELMTS_MAX  ! max, over all versions, used in dataset header
...
#undef H5Z_ZFP_MODE_REVERSIBLE
  ...
  INTEGER(C_SIZE_T), PARAMETER :: H5Z_ZFP_CD_NELMTS_MEM=H5Z_ZFP_CD_NELMTS_MEM_F  ! used in public API to filter
  INTEGER(C_SIZE_T), PARAMETER :: H5Z_ZFP_CD_NELMTS_MAX=H5Z_ZFP_CD_NELMTS_MAX_F  ! max, over all versions, used in dataset header
  ...
  ! There are no *values* to copy over from C interface to Fortran interface for
  ! these symbols. So, we just undef them to avoid name collision.
#undef H5Pset_zfp_rate_cdata
#undef H5Pset_zfp_precision_cdata
#undef H5Pset_zfp_accuracy_cdata
#undef H5Pset_zfp_expert_cdata
#undef H5Pset_zfp_reversible_cdata
