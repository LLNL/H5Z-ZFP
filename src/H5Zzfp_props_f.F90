MODULE H5Zzfp_props_f
  ...
  INTEGER, PARAMETER :: H5Z_FILTER_ZFP=32013

  INTEGER, PARAMETER :: H5Z_FILTER_ZFP_VERSION_MAJOR=1
  INTEGER, PARAMETER :: H5Z_FILTER_ZFP_VERSION_MINOR=0
  INTEGER, PARAMETER :: H5Z_FILTER_ZFP_VERSION_PATCH=1
