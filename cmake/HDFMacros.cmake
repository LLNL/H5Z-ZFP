...
macro (HDF5_SUPPORT)
  if (NOT H5Z-ZFP_HDF5_HEADER)
    ...
    if (HDF5_static_C_FOUND)
      set(_HDF5_STATIC_C_STATUS "1")
    else()
      set(_HDF5_STATIC_C_STATUS "0")
    endif()
    if (HDF5_shared_C_FOUND)
      set(_HDF5_SHARED_C_STATUS "1")
    else()
      set(_HDF5_SHARED_C_STATUS "0")
    endif()
    if (FORTRAN_INTERFACE)
      if (HDF5_static_Fortran_FOUND)
        set(_HDF5_STATIC_FORTRAN_STATUS "1")
      else()
        set(_HDF5_STATIC_FORTRAN_STATUS "0")
      endif()
      if (HDF5_shared_Fortran_FOUND)
        set(_HDF5_SHARED_FORTRAN_STATUS "1")
      else()
        set(_HDF5_SHARED_FORTRAN_STATUS "0")
      endif()
    endif()
    message (STATUS "HDF5 C libs: static: ${_HDF5_STATIC_C_STATUS} and shared: ${_HDF5_SHARED_C_STATUS}")
    if (FORTRAN_INTERFACE)
      message (STATUS "HDF5 Fortran libs: static: ${_HDF5_STATIC_FORTRAN_STATUS} and shared: ${_HDF5_SHARED_FORTRAN_STATUS}")
    endif()
    if (HDF5_FOUND)
      if (HDF5_shared_C_FOUND)
