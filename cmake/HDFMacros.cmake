  ...
  if (NOT H5Z-ZFP_HDF5_HEADER)
    ...
    if (HDF5_FOUND)
      if (HDF5_shared_C_FOUND)
        # Try to find h5dump-shared first, fall back to h5dump
        ...
        # Try to find h5diff-shared first, fall back to h5diff
        ...
        # Try to find h5repack-shared first, fall back to h5repack
        ...
        # Set executables - will be resolved later based on what exists
      ...
      if (NOT HDF5_static_C_FOUND AND NOT HDF5_shared_C_FOUND)
        ...
        if (HDF5_shared_C_FOUND)
          ...
          # Check if -shared suffix tools exist, otherwise use non-suffixed versions
          if (EXISTS "${HDF5_TOOLS_DIR}/h5dump-shared")
            set_property (TARGET ${HDF5_NAMESPACE}h5dump-shared PROPERTY IMPORTED_LOCATION "${HDF5_TOOLS_DIR}/h5dump-shared")
          elseif (EXISTS "${HDF5_TOOLS_DIR}/h5dump")
            set_property (TARGET ${HDF5_NAMESPACE}h5dump-shared PROPERTY IMPORTED_LOCATION "${HDF5_TOOLS_DIR}/h5dump")
          endif ()
          if (EXISTS "${HDF5_TOOLS_DIR}/h5diff-shared")
            set_property (TARGET ${HDF5_NAMESPACE}h5diff-shared PROPERTY IMPORTED_LOCATION "${HDF5_TOOLS_DIR}/h5diff-shared")
          elseif (EXISTS "${HDF5_TOOLS_DIR}/h5diff")
            set_property (TARGET ${HDF5_NAMESPACE}h5diff-shared PROPERTY IMPORTED_LOCATION "${HDF5_TOOLS_DIR}/h5diff")
          endif ()
          if (EXISTS "${HDF5_TOOLS_DIR}/h5repack-shared")
            set_property (TARGET ${HDF5_NAMESPACE}h5repack-shared PROPERTY IMPORTED_LOCATION "${HDF5_TOOLS_DIR}/h5repack-shared")
          elseif (EXISTS "${HDF5_TOOLS_DIR}/h5repack")
            set_property (TARGET ${HDF5_NAMESPACE}h5repack-shared PROPERTY IMPORTED_LOCATION "${HDF5_TOOLS_DIR}/h5repack")
          endif ()
        else ()
          set (HDF5_FOUND 0)
        endif ()
